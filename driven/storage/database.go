...
func (m *database) applyApplicationConfigsChecks(applicationConfigs *collectionWrapper) error {
	...
	err := applicationConfigs.AddIndex(bson.D{primitive.E{Key: "app_type.id", Value: 1}, primitive.E{Key: "app_org_id", Value: 1}, primitive.E{Key: "version_numbers.major", Value: -1}, primitive.E{Key: "version_numbers.minor", Value: -1}, primitive.E{Key: "version_numbers.patch", Value: -1}}, true)
	if err != nil {
		return err
	}
