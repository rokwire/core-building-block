...
func accountAuthTypeFromStorage(item accountAuthType) model.AccountAuthType {
	...
	active := item.Active
	return model.AccountAuthType{ID: id, AuthTypeCode: item.AuthTypeCode, Identifier: identifier, Params: params, Credential: credential,
...
func accountAuthTypeToStorage(item model.AccountAuthType) accountAuthType {
	...
	return accountAuthType{ID: item.ID, AuthTypeCode: item.AuthTypeCode, Identifier: item.Identifier, Params: item.Params, CredentialID: credentialID,
...
func credentialFromStorage(item credential) model.Credential {
	...
	return model.Credential{ID: item.ID, AuthTypeCode: item.AuthTypeCode, AccountsAuthTypes: accountAuthTypes, Verified: item.Verified,
...
func credentialToStorage(item *model.Credential) *credential {
	...
	return &credential{ID: item.ID, AuthTypeCode: item.AuthTypeCode, AccountsAuthTypes: accountAuthTypes, Verified: item.Verified,
		Value: item.Value, DateCreated: item.DateCreated, DateUpdated: item.DateUpdated}
}
