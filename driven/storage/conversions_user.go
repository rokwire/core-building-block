...
func accountFromStorage(item account, appOrg model.ApplicationOrganization) model.Account {
	...
	return model.Account{ID: item.ID, AppOrg: appOrg, Anonymous: item.Anonymous, HasPermissions: item.HasPermissions, Permissions: item.Permissions,
...
func accountToStorage(item *model.Account) *account {
	...
	return &account{ID: id, AppOrgID: appOrgID, Anonymous: item.Anonymous, HasPermissions: item.HasPermissions, Permissions: permissions, Roles: roles, Groups: groups, AuthTypes: authTypes,
