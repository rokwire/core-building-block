...
//FindServiceID finds serviceID
func (sa *Adapter) FindServiceID(appID string) (*model.ApplicationOrganization, error) {
	filter := bson.D{primitive.E{Key: "app_id", Value: appID}}
	...
	serviceIDRes := result[0]
	return &serviceIDRes, nil
}
