...
func main() {
	...
	//web adapter
	webAdapter := web.NewWebAdapter(env, authImpl.ServiceRegManager, port, coreAPIs, host, storageAdapter, baseServerURL, prodServerURL, testServerURL, devServerURL, logger)
	webAdapter.Start()
}
