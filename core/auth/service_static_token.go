...
func (s *staticTokenServiceAuthImpl) checkCredentials(_ *sigauth.Request, creds interface{}, params map[string]interface{}) ([]model.ServiceAccount, error) {
	tokenCreds, err := utils.Convert[staticTokenCreds](creds)
	if err != nil || tokenCreds == nil {
		return nil, errors.WrapErrorAction(logutils.ActionCast, TypeStaticTokenCreds, nil, err)
	}
