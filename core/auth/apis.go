...
func (a *Auth) Login(authenticationType string, creds string, appTypeIdentifier string, orgID string, params string, anonymousID string, profilData model.Profile, preferences map[string]interface{}, l *logs.Log) (string, string, string, *model.Account, interface{}, error) {
	...
	if authType.IsAnonymous {
		...
		message, account, accountAuthType, err = a.applyAuthType(*authType, *appType, *appOrg, creds, params, anonymousID, profilData, preferences, l)
		if err != nil {
