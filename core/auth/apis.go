...
func (a *Auth) Login(authenticationType string, creds string, appTypeIdentifier string, orgID string, params string, anonymousID string, profileData model.Profile, preferences map[string]interface{}, l *logs.Log) (string, string, string, *model.Account, interface{}, error) {
	...
	if authType.IsAnonymous {
		...
		account, accountAuthType, responseParams, err = a.applyExternalAuthType(*authType, *appType, *appOrg, creds, params, anonymousID, profileData, preferences, l)
		if err != nil {
		...
		message, account, accountAuthType, err = a.applyAuthType(*authType, *appType, *appOrg, creds, params, anonymousID, profileData, preferences, l)
		if err != nil {
