...
func (a *Auth) mockExternalLogin() (*model.ExternalSystemUser, map[string]interface{}, string) {
	externalUser := model.ExternalSystemUser{Identifier: "445599", FirstName: "Иван", LastName: "Владов",
		Email: "ivan@illinois.edu", Roles: []string{"role 1", "role 2"}}
...
func (a *Auth) applyOrgSignUpExternal(context storage.TransactionContext, authType model.AuthType, appOrg model.ApplicationOrganization, externalUser model.ExternalSystemUser,
	...
	identifier, aatParams, profile, preferences, err := a.prepareExternalUserData(authType, appOrg, externalUser, regProfile, regPreferences, l)
	if err != nil {
