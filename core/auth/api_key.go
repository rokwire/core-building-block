...
func (a *apiKeyAuthImpl) verify(id string, verification string, l *logs.Log) error {
	return errors.New(logutils.Unimplemented)
}
func (a *apiKeyAuthImpl) checkCredentials(userAuthType *model.AccountAuthType, creds string, appOrg model.ApplicationOrganization, l *logs.Log) (*bool, *bool, error) {
	return nil, nil, nil
}
