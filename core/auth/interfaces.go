...
type Storage interface {
	...
	UpdateAccountPermissions(context storage.TransactionContext, accountID string, admin bool, permissions []model.Permission) error

	//ApplicationRoles
	FindAppOrgRolesByIDs(context storage.TransactionContext, ids []string, appOrgID string) ([]model.AppOrgRole, error)
	//AccountRoles
	UpdateAccountRoles(context storage.TransactionContext, accountID string, admin bool, roles []model.AccountRole) error
	...
	//AccountGroups
	UpdateAccountGroups(context storage.TransactionContext, accountID string, admin bool, groups []model.AccountGroup) error
