...
type authCommunicationChannel interface {
	...
	sendVerifyIdentifier(accountIdentifier *model.AccountIdentifier, appName string, credID string) (bool, error)

	//restarts the identifier verification
	restartIdentifierVerification(accountIdentifier *model.AccountIdentifier, appName string, credID string) error

	//sendCode sends a verification code using the channel
	// Returns:
	//	message (string): response message
	sendCode(appName string, code string, codeType string, credID string) (string, error)
