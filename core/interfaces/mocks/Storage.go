...
// DeleteFollow provides a mock function with given fields: appID, orgID, followingID, followerID
func (_m *Storage) DeleteFollow(appID string, orgID string, followingID string, followerID string) error {
	ret := _m.Called(appID, orgID, followingID, followerID)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, string) error); ok {
		r0 = rf(appID, orgID, followingID, followerID)
	} else {
		r0 = ret.Error(0)
	}
...
// FindAccountProfiles provides a mock function with given fields: appID, authTypeID, accountAuthTypeIdentifier
func (_m *Storage) FindAccountProfiles(appID string, authTypeID string, accountAuthTypeIdentifier string) ([]model.Profile, error) {
...
// FindPublicAccounts provides a mock function with given fields: appID, orgID, limit, offset, search, firstName, lastName, username, followingID, followerID, userID
func (_m *Storage) FindPublicAccounts(appID string, orgID string, limit *int, offset *int, search *string, firstName *string, lastName *string, username *string, followingID *string, followerID *string, userID string) ([]model.PublicAccount, error) {
	ret := _m.Called(appID, orgID, limit, offset, search, firstName, lastName, username, followingID, followerID, userID)

	var r0 []model.PublicAccount
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, *int, *int, *string, *string, *string, *string, *string, *string, string) ([]model.PublicAccount, error)); ok {
		return rf(appID, orgID, limit, offset, search, firstName, lastName, username, followingID, followerID, userID)
	}
	if rf, ok := ret.Get(0).(func(string, string, *int, *int, *string, *string, *string, *string, *string, *string, string) []model.PublicAccount); ok {
		r0 = rf(appID, orgID, limit, offset, search, firstName, lastName, username, followingID, followerID, userID)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(string, string, *int, *int, *string, *string, *string, *string, *string, *string, string) error); ok {
		r1 = rf(appID, orgID, limit, offset, search, firstName, lastName, username, followingID, followerID, userID)
	} else {
		r1 = ret.Error(1)
	}
...
// InsertFollow provides a mock function with given fields: follow
func (_m *Storage) InsertFollow(follow model.Follow) error {
	ret := _m.Called(follow)

	var r0 error
	if rf, ok := ret.Get(0).(func(model.Follow) error); ok {
		r0 = rf(follow)
	} else {
		r0 = ret.Error(0)
	}
...
// UpdateAccountPrivacy provides a mock function with given fields: accountID, privacy
func (_m *Storage) UpdateAccountPrivacy(accountID string, privacy model.Privacy) error {
	ret := _m.Called(accountID, privacy)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, model.Privacy) error); ok {
		r0 = rf(accountID, privacy)
	} else {
		r0 = ret.Error(0)
	}
...
// UpdateAccountProfile provides a mock function with given fields: profile
func (_m *Storage) UpdateAccountProfile(profile model.Profile) error {
...
// UpdateAccountVerified provides a mock function with given fields: accountID, appID, orgID, verified
func (_m *Storage) UpdateAccountVerified(accountID string, appID string, orgID string, verified bool) error {
	ret := _m.Called(accountID, appID, orgID, verified)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, bool) error); ok {
		r0 = rf(accountID, appID, orgID, verified)
	} else {
		r0 = ret.Error(0)
	}
