...
type Administration interface {
	...
	AdmGetApplicationLoginSessions(appID string, orgID string, identifier string) ([]model.LoginSession, error)
}
...
type Storage interface {
	...
	FindApplicationLoginSessions(appID string, orgID string, identifier string) ([]model.LoginSession, error)
