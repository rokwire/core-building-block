...
type System interface {
	...
	SysCreateApplication(name string, multiTenant bool, sharedIdentities bool, maxLoginSessionDuration *int, appTypes []model.ApplicationType) (*model.Application, error)
