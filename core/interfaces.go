...
type System interface {
	...
	SysCreatePermission(name string, description string, serviceID string, assigners *[]string, adminManaged bool, inactive bool) (*model.Permission, error)
	SysUpdatePermission(name string, description string, serviceID string, assigners *[]string, adminManaged bool, inactive bool) (*model.Permission, error)
