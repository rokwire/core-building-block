...
// AddMFAType provides a mock function with given fields: accountID, identifier, mfaType
func (_m *APIs) AddMFAType(accountID string, identifier string, mfaType string) (*model.MFAType, error) {
...
// GetAdminToken provides a mock function with given fields: claims, appID, l
func (_m *APIs) GetAdminToken(claims tokenauth.Claims, appID string, l *logs.Log) (string, error) {
	ret := _m.Called(claims, appID, l)

	var r0 string
	if rf, ok := ret.Get(0).(func(tokenauth.Claims, string, *logs.Log) string); ok {
		r0 = rf(claims, appID, l)
	} else {
		r0 = ret.Get(0).(string)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(tokenauth.Claims, string, *logs.Log) error); ok {
		r1 = rf(claims, appID, l)
	} else {
		r1 = ret.Error(1)
	}
...
// GetMFATypes provides a mock function with given fields: accountID
func (_m *APIs) GetMFATypes(accountID string) ([]model.MFAType, error) {
...
// Login provides a mock function with given fields: ipAddress, deviceType, deviceOS, deviceID, authenticationType, creds, apiKey, appTypeIdentifier, orgID, params, profile, preferences, admin, l
func (_m *APIs) Login(ipAddress string, deviceType string, deviceOS *string, deviceID string, authenticationType string, creds string, apiKey string, appTypeIdentifier string, orgID string, params string, profile model.Profile, preferences map[string]interface{}, admin bool, l *logs.Log) (*string, *model.LoginSession, []model.MFAType, error) {
	ret := _m.Called(ipAddress, deviceType, deviceOS, deviceID, authenticationType, creds, apiKey, appTypeIdentifier, orgID, params, profile, preferences, admin, l)

	var r0 *string
	if rf, ok := ret.Get(0).(func(string, string, *string, string, string, string, string, string, string, string, model.Profile, map[string]interface{}, bool, *logs.Log) *string); ok {
		r0 = rf(ipAddress, deviceType, deviceOS, deviceID, authenticationType, creds, apiKey, appTypeIdentifier, orgID, params, profile, preferences, admin, l)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*string)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, *string, string, string, string, string, string, string, string, model.Profile, map[string]interface{}, bool, *logs.Log) *model.LoginSession); ok {
		r1 = rf(ipAddress, deviceType, deviceOS, deviceID, authenticationType, creds, apiKey, appTypeIdentifier, orgID, params, profile, preferences, admin, l)
	} else {
		if ret.Get(1) != nil {
	...
	var r2 []model.MFAType
	if rf, ok := ret.Get(2).(func(string, string, *string, string, string, string, string, string, string, string, model.Profile, map[string]interface{}, bool, *logs.Log) []model.MFAType); ok {
		r2 = rf(ipAddress, deviceType, deviceOS, deviceID, authenticationType, creds, apiKey, appTypeIdentifier, orgID, params, profile, preferences, admin, l)
	} else {
		if ret.Get(2) != nil {
			r2 = ret.Get(2).([]model.MFAType)
		}
	}

	var r3 error
	if rf, ok := ret.Get(3).(func(string, string, *string, string, string, string, string, string, string, string, model.Profile, map[string]interface{}, bool, *logs.Log) error); ok {
		r3 = rf(ipAddress, deviceType, deviceOS, deviceID, authenticationType, creds, apiKey, appTypeIdentifier, orgID, params, profile, preferences, admin, l)
	} else {
		r3 = ret.Error(3)
	}
...
// LoginMFA provides a mock function with given fields: apiKey, accountID, sessionID, identifier, mfaType, mfaCode, state, l
func (_m *APIs) LoginMFA(apiKey string, accountID string, sessionID string, identifier string, mfaType string, mfaCode string, state string, l *logs.Log) (*string, *model.LoginSession, error) {
	ret := _m.Called(apiKey, accountID, sessionID, identifier, mfaType, mfaCode, state, l)

	var r0 *string
	if rf, ok := ret.Get(0).(func(string, string, string, string, string, string, string, *logs.Log) *string); ok {
		r0 = rf(apiKey, accountID, sessionID, identifier, mfaType, mfaCode, state, l)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*string)
		}
	...
	var r1 *model.LoginSession
	if rf, ok := ret.Get(1).(func(string, string, string, string, string, string, string, *logs.Log) *model.LoginSession); ok {
		r1 = rf(apiKey, accountID, sessionID, identifier, mfaType, mfaCode, state, l)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*model.LoginSession)
		}
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(string, string, string, string, string, string, string, *logs.Log) error); ok {
		r2 = rf(apiKey, accountID, sessionID, identifier, mfaType, mfaCode, state, l)
	} else {
		r2 = ret.Error(2)
	}
...
// RemoveMFAType provides a mock function with given fields: accountID, identifier, mfaType
func (_m *APIs) RemoveMFAType(accountID string, identifier string, mfaType string) error {
	ret := _m.Called(accountID, identifier, mfaType)
...
// VerifyMFA provides a mock function with given fields: accountID, identifier, mfaType, mfaCode
func (_m *APIs) VerifyMFA(accountID string, identifier string, mfaType string, mfaCode string) (*string, []string, error) {
	ret := _m.Called(accountID, identifier, mfaType, mfaCode)

	var r0 *string
	if rf, ok := ret.Get(0).(func(string, string, string, string) *string); ok {
		r0 = rf(accountID, identifier, mfaType, mfaCode)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*string)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, string, string) []string); ok {
		r1 = rf(accountID, identifier, mfaType, mfaCode)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).([]string)
		}
	...
	if rf, ok := ret.Get(2).(func(string, string, string, string) error); ok {
		r2 = rf(accountID, identifier, mfaType, mfaCode)
	} else {
		r2 = ret.Error(2)
	}
