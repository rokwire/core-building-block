...
// FindAppOrgGroupByID provides a mock function with given fields: id, appID, orgID
func (_m *Storage) FindAppOrgGroupByID(id string, appID string, orgID string) (*model.AppOrgGroup, error) {
	ret := _m.Called(id, appID, orgID)

	var r0 *model.AppOrgGroup
	if rf, ok := ret.Get(0).(func(string, string, string) *model.AppOrgGroup); ok {
		r0 = rf(id, appID, orgID)
	} else {
		if ret.Get(0) != nil {
