...
// FindAppOrg provides a mock function with given fields: appID, orgID
func (_m *Storage) FindAppOrg(appID string, orgID string) (*model.ApplicationOrganization, error) {
...
// FindAppOrgRole provides a mock function with given fields: appOrgID
func (_m *Storage) FindAppOrgRole(appOrgID string) ([]model.AppOrgRole, error) {
