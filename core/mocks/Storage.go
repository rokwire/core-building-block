...
// FindPublicAccounts provides a mock function with given fields: context, appID, orgID, limit, offset, search, firstName, lastName, username, followingID, followerID, unstructuredProperties, userID, ids
func (_m *Storage) FindPublicAccounts(context storage.TransactionContext, appID string, orgID string, limit *int, offset *int, search *string, firstName *string, lastName *string, username *string, followingID *string, followerID *string, unstructuredProperties map[string]string, userID string, ids *[]string) ([]model.PublicAccount, error) {
	ret := _m.Called(context, appID, orgID, limit, offset, search, firstName, lastName, username, followingID, followerID, unstructuredProperties, userID, ids)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(storage.TransactionContext, string, string, *int, *int, *string, *string, *string, *string, *string, *string, map[string]string, string, *[]string) ([]model.PublicAccount, error)); ok {
		return rf(context, appID, orgID, limit, offset, search, firstName, lastName, username, followingID, followerID, unstructuredProperties, userID, ids)
	}
	if rf, ok := ret.Get(0).(func(storage.TransactionContext, string, string, *int, *int, *string, *string, *string, *string, *string, *string, map[string]string, string, *[]string) []model.PublicAccount); ok {
		r0 = rf(context, appID, orgID, limit, offset, search, firstName, lastName, username, followingID, followerID, unstructuredProperties, userID, ids)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(storage.TransactionContext, string, string, *int, *int, *string, *string, *string, *string, *string, *string, map[string]string, string, *[]string) error); ok {
		r1 = rf(context, appID, orgID, limit, offset, search, firstName, lastName, username, followingID, followerID, unstructuredProperties, userID, ids)
	} else {
		r1 = ret.Error(1)
	}
