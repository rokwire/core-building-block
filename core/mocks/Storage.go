...
// RevokeAccountRoles provides a mock function with given fields: context, accountID, roleIDs
func (_m *Storage) RevokeAccountRoles(context storage.TransactionContext, accountID string, roleIDs []string) error {
