...
// CreateGlobalPermissions provides a mock function with given fields: name
func (_m *Storage) CreateGlobalPermissions(name string) (*model.GlobalPermission, error) {
	ret := _m.Called(name)
