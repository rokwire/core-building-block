...
// ReadAllBuildingBlocks provides a mock function with given fields: appID, orgID
func (_m *Storage) ReadAllBuildingBlocks(appID string, orgID string) ([]*model.BuildingBlock, error) {
	ret := _m.Called(appID, orgID)

	var r0 []*model.BuildingBlock
	if rf, ok := ret.Get(0).(func(string, string) []*model.BuildingBlock); ok {
		r0 = rf(appID, orgID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*model.BuildingBlock)
		}
	}
