...
// DeleteFlaggedAccounts provides a mock function with given fields: cutoff
func (_m *Storage) DeleteFlaggedAccounts(cutoff time.Time) error {
	ret := _m.Called(cutoff)

	if len(ret) == 0 {
		panic("no return value specified for DeleteFlaggedAccounts")
	}
