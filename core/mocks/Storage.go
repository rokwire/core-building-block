...
// FindGlobalGroupList provides a mock function with given fields: id, name
func (_m *Storage) FindGlobalGroupList(id *string, name *string) ([]model.GlobalGroup, error) {
	ret := _m.Called(id, name)

	var r0 []model.GlobalGroup
	if rf, ok := ret.Get(0).(func(*string, *string) []model.GlobalGroup); ok {
		r0 = rf(id, name)
	} else {
		if ret.Get(0) != nil {
