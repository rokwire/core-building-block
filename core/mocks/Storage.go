...
// RemoveGroupAccounts provides a mock function with given fields: context, acountIDs, groupID
func (_m *Storage) RemoveGroupAccounts(context storage.TransactionContext, acountIDs []string, groupID string) error {
	ret := _m.Called(context, acountIDs, groupID)

	var r0 error
	if rf, ok := ret.Get(0).(func(storage.TransactionContext, []string, string) error); ok {
		r0 = rf(context, acountIDs, groupID)
	} else {
		r0 = ret.Error(0)
	}
