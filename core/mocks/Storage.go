...
// FindAccountsCountByParams provides a mock function with given fields: searchParams, appID, orgID, limit, offset, allAccess, approvedKeys
func (_m *Storage) FindAccountsCountByParams(searchParams map[string]interface{}, appID string, orgID string, limit int, offset int, allAccess bool, approvedKeys []string) (int64, error) {
	ret := _m.Called(searchParams, appID, orgID, limit, offset, allAccess, approvedKeys)

	var r0 int64
	if rf, ok := ret.Get(0).(func(map[string]interface{}, string, string, int, int, bool, []string) int64); ok {
		r0 = rf(searchParams, appID, orgID, limit, offset, allAccess, approvedKeys)
	} else {
		r0 = ret.Get(0).(int64)
	}
