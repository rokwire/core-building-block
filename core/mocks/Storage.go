...
func (_m *Storage) FindDeletedOrgAppMemberships(appID string, orgID string) ([]model.DeletedOrgAppMembership, error) {
	ret := _m.Called(appID, orgID)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) ([]model.DeletedOrgAppMembership, error)); ok {
		return rf(appID, orgID)
	}
	if rf, ok := ret.Get(0).(func(string, string) []model.DeletedOrgAppMembership); ok {
		r0 = rf(appID, orgID)
	} else {
		if ret.Get(0) != nil {
