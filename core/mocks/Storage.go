...
// DeleteLoginSessionsByRoleID provides a mock function with given fields: transaction, appID, orgID, roleID
func (_m *Storage) DeleteLoginSessionsByRoleID(transaction storage.TransactionContext, appID string, orgID string, roleID string) error {
	ret := _m.Called(transaction, appID, orgID, roleID)

	var r0 error
	if rf, ok := ret.Get(0).(func(storage.TransactionContext, string, string, string) error); ok {
		r0 = rf(transaction, appID, orgID, roleID)
	} else {
		r0 = ret.Error(0)
	}
...
// DeletePermissionsFromRole provides a mock function with given fields: context, appOrgID, roleID, permissions
func (_m *Storage) DeletePermissionsFromRole(context storage.TransactionContext, appOrgID string, roleID string, permissions []model.Permission) error {
	ret := _m.Called(context, appOrgID, roleID, permissions)

	var r0 error
	if rf, ok := ret.Get(0).(func(storage.TransactionContext, string, string, []model.Permission) error); ok {
		r0 = rf(context, appOrgID, roleID, permissions)
	} else {
		r0 = ret.Error(0)
	}
