...
// UpdateAccountProfile provides a mock function with given fields: context, accountID, profile, identifiers
func (_m *Storage) UpdateAccountProfile(context storage.TransactionContext, accountID string, profile model.Profile, identifiers []model.AccountIdentifier) error {
	ret := _m.Called(context, accountID, profile, identifiers)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(storage.TransactionContext, string, model.Profile, []model.AccountIdentifier) error); ok {
		r0 = rf(context, accountID, profile, identifiers)
	} else {
		r0 = ret.Error(0)
	}
