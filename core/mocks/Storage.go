...
// DeleteLoginSessionsByIdentifiers provides a mock function with given fields: transaction, identifiers
func (_m *Storage) DeleteLoginSessionsByIdentifiers(transaction storage.TransactionContext, identifiers []string) error {
	ret := _m.Called(transaction, identifiers)

	var r0 error
	if rf, ok := ret.Get(0).(func(storage.TransactionContext, []string) error); ok {
		r0 = rf(transaction, identifiers)
	} else {
		r0 = ret.Error(0)
	}
...
// FindAccountsByRoleID provides a mock function with given fields: context, appID, orgID, roleID
func (_m *Storage) FindAccountsByRoleID(context storage.TransactionContext, appID string, orgID string, roleID string) ([]model.Account, error) {
	ret := _m.Called(context, appID, orgID, roleID)

	var r0 []model.Account
	if rf, ok := ret.Get(0).(func(storage.TransactionContext, string, string, string) []model.Account); ok {
		r0 = rf(context, appID, orgID, roleID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.Account)
		}
	...
	if rf, ok := ret.Get(1).(func(storage.TransactionContext, string, string, string) error); ok {
		r1 = rf(context, appID, orgID, roleID)
	} else {
		r1 = ret.Error(1)
	}
