...
// FindAccountsByAccountID provides a mock function with given fields: accountIDs
func (_m *Storage) FindAccountsByAccountID(accountIDs []string) ([]model.Account, error) {
...
// InsertGroupAccounts provides a mock function with given fields: groupID, account
func (_m *Storage) InsertGroupAccounts(groupID string, account []model.Account) error {
	ret := _m.Called(groupID, account)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, []model.Account) error); ok {
		r0 = rf(groupID, account)
	} else {
		r0 = ret.Error(0)
	}
