...
// CountAccountsByGroupID provides a mock function with given fields: context, groupID
func (_m *Storage) CountAccountsByGroupID(context storage.TransactionContext, groupID string) (*int, error) {
	ret := _m.Called(context, groupID)

	var r0 *int
	if rf, ok := ret.Get(0).(func(storage.TransactionContext, string) *int); ok {
		r0 = rf(context, groupID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*int)
		}
...
// FindAppOrgRolesByID provides a mock function with given fields: ids
func (_m *Storage) FindAppOrgRolesByID(ids []string) ([]model.AppOrgRole, error) {
	ret := _m.Called(ids)
...
// InsertAdmAppOrgGroup provides a mock function with given fields: item
func (_m *Storage) InsertAdmAppOrgGroup(item model.AppOrgGroup) error {
	ret := _m.Called(item)
