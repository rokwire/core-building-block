...
// FindAccountsByParams provides a mock function with given fields: searchParams, appID, orgID, limit, offset, allAccess, approvedKeys, rangeIndex
func (_m *Storage) FindAccountsByParams(searchParams map[string]interface{}, appID string, orgID string, limit int, offset int, allAccess bool, approvedKeys []string, rangeIndex string) ([]map[string]interface{}, error) {
	ret := _m.Called(searchParams, appID, orgID, limit, offset, allAccess, approvedKeys, rangeIndex)

	var r0 []map[string]interface{}
	if rf, ok := ret.Get(0).(func(map[string]interface{}, string, string, int, int, bool, []string, string) []map[string]interface{}); ok {
		r0 = rf(searchParams, appID, orgID, limit, offset, allAccess, approvedKeys, rangeIndex)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(map[string]interface{}, string, string, int, int, bool, []string, string) error); ok {
		r1 = rf(searchParams, appID, orgID, limit, offset, allAccess, approvedKeys, rangeIndex)
	} else {
		r1 = ret.Error(1)
	}
