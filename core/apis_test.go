...
func TestSerGetVersion(t *testing.T) {
	...
	coreAPIs := core.NewCoreAPIs("local", "1.1.1", "build", &storage, nil, nil)
...
func TestSysCreateGlobalConfig(t *testing.T) {
	...
	app := core.NewCoreAPIs("local", "1.1.1", "build", &storage, nil, nil)
	...
	app = core.NewCoreAPIs("local", "1.1.1", "build", &storage2, nil, nil)
