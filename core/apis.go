...
func (s *administrationImpl) AdmGetSessions(anonymous *bool, userRole *string, start *time.Time, end *time.Time) ([]model.Sessions, error) {
	return s.app.admGetSessions(anonymous, userRole, start, end)
}
