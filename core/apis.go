...
func (s *administrationImpl) AdmGetAccounts(accountID string, identifier string, appID string) ([]model.Account, error) {
	return s.app.admGetAccounts(accountID, identifier, appID)
}
