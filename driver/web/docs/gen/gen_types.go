...
// ResGetApplicationsOrganizationsResponse defines model for _res_get_ApplicationsOrganizations_Response.
type ResGetApplicationsOrganizationsResponse struct {
