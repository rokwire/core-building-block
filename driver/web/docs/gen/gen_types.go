...
// ReqApplicationConfigsRequest defines model for _req_application_configs_Request.
type ReqApplicationConfigsRequest struct {
	ApiKey            string `json:"api_key"`
	AppTypeIdentifier string `json:"app_type_identifier"`
...
// ReqApplicationOrgConfigsRequest defines model for _req_application_org-configs_Request.
type ReqApplicationOrgConfigsRequest struct {
	AppTypeIdentifier string `json:"app_type_identifier"`
...
type PostServicesApplicationConfigsJSONBody ReqApplicationConfigsRequest

// PostServicesApplicationOrgConfigsJSONBody defines parameters for PostServicesApplicationOrgConfigs.
type PostServicesApplicationOrgConfigsJSONBody ReqApplicationOrgConfigsRequest
...
type PostSystemApplicationConfigsJSONBody ReqCreateApplicationConfigRequest

// PutSystemApplicationConfigsIdJSONBody defines parameters for PutSystemApplicationConfigsId.
type PutSystemApplicationConfigsIdJSONBody ReqCreateApplicationConfigRequest
...
// PostServicesApplicationOrgConfigsJSONRequestBody defines body for PostServicesApplicationOrgConfigs for application/json ContentType.
type PostServicesApplicationOrgConfigsJSONRequestBody PostServicesApplicationOrgConfigsJSONBody
