...
// Defines values for ReqLoginUrlAdminRequestAuthType.
const (
	ReqLoginUrlAdminRequestAuthTypeIllinoisOidc ReqLoginUrlAdminRequestAuthType = "illinois_oidc"
)
...
// ReqLoginUrlAdminRequest defines model for _req_login-url_admin_Request.
type ReqLoginUrlAdminRequest struct {
	AppTypeIdentifier string                          `json:"app_type_identifier"`
	AuthType          ReqLoginUrlAdminRequestAuthType `json:"auth_type"`
	OrgId             string                          `json:"org_id"`
	RedirectUri       string                          `json:"redirect_uri"`
}

// ReqLoginUrlAdminRequestAuthType defines model for ReqLoginUrlAdminRequest.AuthType.
type ReqLoginUrlAdminRequestAuthType string
...
// ResLoginUrlAdminResponse defines model for _res_login-url_admin_Response.
type ResLoginUrlAdminResponse struct {
	LoginUrl string `json:"login_url"`
