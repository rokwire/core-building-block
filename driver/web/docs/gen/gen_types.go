...
// ReqGrantPermissionsRequest defines model for _req_grant-permissions_Request.
type ReqGrantPermissionsRequest struct {
...
type PutAdminApplicationAccountPermissionsGrantJSONBody ReqGrantPermissionsRequest
