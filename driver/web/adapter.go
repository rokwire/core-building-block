...
func (we Adapter) Start() {
	...
	adminSubrouter.HandleFunc("/application/account/{account_id}/session/{session_id}", we.wrapFunc(we.adminApisHandler.deleteLoginSession, we.auth.admin.permissions)).Methods("DELETE")
	///
