...
func (we Adapter) Start() {
	...
	adminSubrouter.HandleFunc("/application/{identifier}/login-sessions/{account_auth_type_identifier}", we.wrapFunc(we.adminApisHandler.getApplicationLoginSessions, we.auth.admin.user)).Methods("GET")
