...
func (we Adapter) Start() {
	...
	servicesSubRouter.HandleFunc("/v2/accounts/public/index", we.wrapFunc(we.servicesApisHandler.getPublicAccountsLetterIndex, we.auth.services.Standard)).Methods("GET")
