...
func (we Adapter) Start() {
	...
	adminSubrouter.HandleFunc("/application/groups/{group_id}", we.wrapFunc(we.adminApisHandler.adminDeleteApplicationOrgGroups, we.auth.admin.permissions)).Methods("DELETE")
