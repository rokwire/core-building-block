...
func (we Adapter) Start() {
	...
	adminSubrouter.HandleFunc("/application/account/device", we.wrapFunc(we.adminApisHandler.getApplicationAccountDevices, we.auth.admin.permissions)).Methods("GET")
