...
func (we Adapter) Start() {
	...
	systemSubrouter.HandleFunc("/accounts", we.wrapFunc(we.systemApisHandler.createAdminAccount, we.auth.system.permissions)).Methods("POST")
	systemSubrouter.HandleFunc("/accounts", we.wrapFunc(we.systemApisHandler.updateAdminAccount, we.auth.system.permissions)).Methods("PUT")
