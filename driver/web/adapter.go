...
func (we Adapter) Start() {
	...
	adminSubrouter.HandleFunc("/application/roles/{roles_id}", we.wrapFunc(we.adminApisHandler.adminDeleteApplicationOrgRoles, we.auth.admin.permissions)).Methods("DELETE")
