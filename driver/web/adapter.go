...
func (we Adapter) Start() {
	...
	servicesSubRouter.HandleFunc("/account/mfa", we.wrapFunc(we.servicesApisHandler.enrollMFA, we.auth.servicesUserAuth)).Methods("POST")
	servicesSubRouter.HandleFunc("/account/mfa", we.wrapFunc(we.servicesApisHandler.removeMFA, we.auth.servicesUserAuth)).Methods("DELETE")
