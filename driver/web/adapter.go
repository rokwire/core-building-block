...
func (we Adapter) Start() {
	...
	adminSubrouter.HandleFunc("/application/roles/{id}", we.wrapFunc(we.adminApisHandler.adminDeleteApplicationOrgRoles, we.auth.admin.permissions)).Methods("DELETE")
