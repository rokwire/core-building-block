...
func (we Adapter) Start() {
	...
	adminSubrouter.HandleFunc("/application/role/permissions/revoke", we.wrapFunc(we.adminApisHandler.adminRevokePermissionsFromRole, we.auth.admin.permissions)).Methods("DELETE")
