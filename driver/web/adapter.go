...
func (we Adapter) Start() {
	...
	servicesSubRouter.HandleFunc("/accounts", we.wrapFunc(we.servicesApisHandler.createAccount, we.auth.services.permissions)).Methods("POST")
	...
	adminSubrouter.HandleFunc("/application/accounts", we.wrapFunc(we.adminApisHandler.createAccount, we.auth.admin.permissions)).Methods("POST")
	adminSubrouter.HandleFunc("/application/accounts", we.wrapFunc(we.adminApisHandler.updateAdminAccount, we.auth.services.permissions)).Methods("PUT")
	...
	systemSubrouter.HandleFunc("/application-roles", we.wrapFunc(we.systemApisHandler.createApplicationRole, we.auth.system.permissions)).Methods("POST")
	systemSubrouter.HandleFunc("/application-api-keys", we.wrapFunc(we.systemApisHandler.getApplicationAPIKeys, we.auth.system.permissions)).Methods("GET")
	...
	systemSubrouter.HandleFunc("/accounts", we.wrapFunc(we.systemApisHandler.createAccount, we.auth.system.permissions)).Methods("POST")
	systemSubrouter.HandleFunc("/accounts", we.wrapFunc(we.systemApisHandler.updateAdminAccount, we.auth.services.permissions)).Methods("PUT")
	...
	systemSubrouter.HandleFunc("/api-keys", we.wrapFunc(we.systemApisHandler.getAPIKey, we.auth.system.permissions)).Methods("GET")
