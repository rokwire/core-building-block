...
func (h AdminApisHandler) adminLogin(l *logs.Log, r *http.Request, claims *tokenauth.Claims) logs.HttpResponse {
	...
	//message
	if message != nil {
		responseData := &Def.ResLoginAdminResponse{Message: message}
...
func (h AdminApisHandler) adminLoginURL(l *logs.Log, r *http.Request, claims *tokenauth.Claims) logs.HttpResponse {
	...
	var requestData Def.ReqLoginUrlAdminRequest
	err = json.Unmarshal(data, &requestData)
	if err != nil {
	...
	responseData := &Def.ResLoginUrlAdminResponse{LoginUrl: loginURL, Params: &params}
	respData, err := json.Marshal(responseData)
	if err != nil {
